...
public class productDetails {
	 ...
	 public productDetails()          //Default Constructor
	 {
		 
	 }
	 
	public productDetails(int pid, String pname, int pamount, int pcode, String paddress, int ppincode) {
		this.pid = pid;
		this.pname = pname;
	...
	public static void main(String[] args) {
		...
		productDetails p1 = new productDetails();  		                             //Storing in Hashmap
		Map<Integer, productDetails> hs3 = new HashMap();
		hs3.put(pid, p1);
